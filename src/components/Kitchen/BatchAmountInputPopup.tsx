    ...
    return (
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-md w-full p-6 text-center"
        >
  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ scale: 0.9, y: 20 }}
        onClick={(e) => e.stopPropagation()}
        className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-3xl w-full max-h-[80vh] flex flex-col"
      >
        {/* 헤더 - v3.1: 웍/튀김기 구분 */}
        <div className={`p-4 border-b flex justify-between items-center ${
          targetType === 'wok'
            ? 'bg-blue-500 rounded-t-2xl'
            : 'bg-amber-500 rounded-t-2xl'
        }`}>
          <div>
                      ...
                      <div key={target.id} className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-1">
                          <input
                            ...
                            className={`flex-1 px-2 py-2 border border-gray-300 rounded text-center font-bold text-gray-800 focus:outline-none ${
        ...
        <div className="p-4 border-t bg-white flex justify-end gap-3">
          ...
          <button
            ...
            className="px-6 py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white font-bold text-sm"
          >
            ✓ 모두 투입하기
          </button>
        </div>
